...
public class Money implements Comparable {
	...
	public String toString() {
        ...
        return decimal.format(amount / 100.0) + " " + currency.getName();
    }
	...
	public Money add(Money other) {
		int a = this.amount;
		int b = other.getAmount();
		if (this.currency.equals(other.getCurrency())) {
			return new Money(a + b, this.currency);
        } else {
        	int c = (int) Math.round(b * other.getCurrency().getRate() / currency.getRate());
            return new Money(a + c, this.currency);
        }
	}
	...
	public int compareTo(Object other) {
        return Integer.compare(this.universalValue(), ((Money)other).universalValue());
	}
}